...
module HP_SP_Status_Screen_SPI(
    input basys_clk,
    input done,
...
//    );
    ...
    wire [5:0] damage_width = display_hp_width - final_hp_width;

    rectangle_generator hp_rect_damage (
        .X(x_8bit), .Y(y_8bit),
        .OriginX(2 + final_hp_width), // start from final HP boundary
        .OriginY(10),
        .width(damage_width),
        .height(7),
        .rect_color(16'hF800), // red
